export const UPDATE_LANGUAGE = 'UPDATE_LANGUAGE'; // 更新语言
export const UPDATE_WALLETS = 'UPDATE_WALLETS'; // 更新钱包列表
export const UPDATE_CURRENT_WALLET = 'UPDATE_CURRENT_WALLET'; // 更新当前钱包
