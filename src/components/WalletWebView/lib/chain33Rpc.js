(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.chain33Rpc = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
},{"json-bigint":5}],2:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
var BtyBaseSdk = /** @class */ (function () {
     ...
     * @memberof BtyBaseSdk
     */
    BtyBaseSdk.prototype.getProperFee = function (txCount, txSize, url) {
        if (url === void 0) { url = ''; }
        var postdata = {};
        if (txCount) {
            postdata['txCount'] = txCount;
        }
        if (txSize) {
            postdata['txSize'] = txSize;
        }
        return this.callPromiseAPI('GetProperFee', postdata, url);
    };
    /**
    ...
    /**
     * @description 将合约名转化成chain33中的实际地址
    ...
    /**
     * @description manage 管理执行器，主要功能是动态地给其他执行器配置和调整参数值。
     * @param {string} key 目前支持的有：token-finisher，token-blacklist
     * @returns {Promise<any>}
     * @memberof BtyBaseSdk
     */
    BtyBaseSdk.prototype.queryManageConfig = function (key) {
        return this.callPromiseAPI('Query', {
            execer: 'manage',
     ...
     * @memberof BtyBaseSdk
     */
    BtyBaseSdk.prototype.getTokenHistory = function (symbol, execer, url) {
        if (execer === void 0) { execer = 'token'; }
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('Query', {
            execer: execer,
     ...
     * @memberof BtyBaseSdk
     */
    BtyBaseSdk.prototype.createRawTokenMintTx = function (symbol, amount, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('CreateRawTokenMintTx', {
            symbol: symbol,
            amount: amount,
        }, url, 'token');
    };
     ...
     * @memberof BtyBaseSdk
     */
    BtyBaseSdk.prototype.createRawTokenBurnTx = function (symbol, amount, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('CreateRawTokenBurnTx', {
            symbol: symbol,
            amount: amount,
        }, url, 'token');
    };
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.searchTreaty = function (hash, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('Query', {
            execer: 'unfreeze',
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.searchTreatyWithdraw = function (hash, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('Query', {
            execer: 'unfreeze',
     ...
     * @memberof BtyBaseSdk
     */
    BtyBaseSdk.prototype.createRawUnfreezeCreate = function (contact, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('CreateRawUnfreezeCreate', __assign({}, contact), url, 'unfreeze');
    };
    /**
     ...
     * @memberof BtyBaseSdk
     */
    BtyBaseSdk.prototype.createRawUnfreezeWithdraw = function (unfreezeID, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('CreateRawUnfreezeWithdraw', {
     ...
     * @memberof BtyBaseSdk
     */
    BtyBaseSdk.prototype.createRawUnfreezeTerminate = function (unfreezeID, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('CreateRawUnfreezeTerminate', {
            unfreezeID: unfreezeID,
        }, url, 'unfreeze');
    };
    BtyBaseSdk.prototype.listUnfreezeByCreator = function (address, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('Query', {
    ...
    BtyBaseSdk.prototype.listUnfreezeByBeneficiary = function (address, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('Query', {
    ...
    BtyBaseSdk.prototype.createMultipleSignAccount = function (owners, RequiredWeight, dailyLimit, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigAccCreateTx', {
            owners: owners,
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.editRequiredWeight = function (multiSigAccAddr, newRequiredWeight, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigAccOperateTx', {
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.editDailyLimit = function (multiSigAccAddr, dailyLimit, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigAccOperateTx', {
            multiSigAccAddr: multiSigAccAddr,
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.searchMultiSigAccUnSpentToday = function (multiSigAddr, isAll, execer, symbol, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('Query', {
            execer: 'multisig',
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.searchMultiSigAccAssets = function (multiSigAddr, isAll, execer, symbol, url) {
        if (url === void 0) { url = ''; }
        return this.callPromiseAPI('Query', {
            execer: 'multisig',
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.addMultiSigOwnerOperateTx = function (multiSigAccAddr, newOwner, newWeight, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigOwnerOperateTx', {
            multiSigAccAddr: multiSigAccAddr,
            newOwner: newOwner,
            newWeight: newWeight,
            operateFlag: 1,
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.delMultiSigOwnerOperateTx = function (multiSigAccAddr, oldOwner, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigOwnerOperateTx', {
            multiSigAccAddr: multiSigAccAddr,
     ...
     * @param {string} multiSigAccAddr 多重签名账户地址
     * @param {string} oldOwner 需要修改的owner地址
     * @param {uint64} newWeight 新的权重值
     * @param {string} [url='']
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.editMultisigOwnerWeight = function (multiSigAccAddr, oldOwner, newWeight, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigOwnerOperateTx', {
            multiSigAccAddr: multiSigAccAddr,
     ...
     * @returns {Promise<any>}
     */
    BtyBaseSdk.prototype.changeMultisigOwnerAcc = function (multiSigAccAddr, oldOwner, newOwner, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigOwnerOperateTx', {
            multiSigAccAddr: multiSigAccAddr,
    ...
    BtyBaseSdk.prototype.MultisigAccAssetsIn = function (symbol, execname, note, to, amount, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigAccTransferInTx', {
            symbol: symbol,
            execname: execname,
            note: note,
            to: to,
    ...
    BtyBaseSdk.prototype.MultisigAccAssetsOut = function (symbol, execname, note, from, to, amount, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigAccTransferOutTx', {
            symbol: symbol,
            execname: execname,
            note: note,
            from: from,
    ...
    BtyBaseSdk.prototype.confirmMultisigAccTx = function (multiSigAccAddr, txId, confirmOrRevoke, url) {
        if (url === void 0) { url = ''; }
        var prefix = 'multisig';
        return this.callPromiseAPI('MultiSigConfirmTx', {
            multiSigAccAddr: multiSigAccAddr,
            txId: txId,
     ...
     * @param {boolean} pending 显示未执行的交易 true/false
     * @param {boolean} executed 显示已执行的交易 true/false
     * @param {string} [url='']
     * @returns {Promise<any>}
     */
...
},{"./HttpProvider":1,"./tools":3}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
 * @description 比较版本
...
function versionCompare(myV, compareV) {
    var formatReg = /^\d+(\.\d+)+?$/;
    if (!formatReg.test(myV) || !formatReg.test(compareV)) {
        console.log(formatReg.test(myV), formatReg.test(compareV));
        throw new Error('the format of version is not support!');
    }
...
},{"./lib/parse.js":6,"./lib/stringify.js":7}],6:[function(require,module,exports){
var BigNumber = null;
/*
    json_parse.js
    2012-06-20
...
},{"bignumber.js":4}],7:[function(require,module,exports){
