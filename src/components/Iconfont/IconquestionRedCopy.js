...
export const IconquestionRedCopy = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      <Path
        ...
        fill={getIconColor(color, 0, '#FC5D68')}
      />
      <Path
        ...
        fill={getIconColor(color, 1, '#FC5D68')}
      />
    </Svg>
  );
};

IconquestionRedCopy.defaultProps = {
  size: 18,
};

export default IconquestionRedCopy;
