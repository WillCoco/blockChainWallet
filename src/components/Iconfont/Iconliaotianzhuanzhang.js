...
export const Iconliaotianzhuanzhang = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      ...
      <Path
        ...
        fill={getIconColor(color, 1, '#2698FB')}
      />
      <Path
        ...
        fill={getIconColor(color, 2, '#2698FB')}
      />
    </Svg>
  );
};

Iconliaotianzhuanzhang.defaultProps = {
  size: 18,
};

export default Iconliaotianzhuanzhang;
